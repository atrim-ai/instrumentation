...
// Import from the main index.js - uses Layer.suspend to defer global provider setup
// until the layer is actually used, so it won't interfere with test-provided providers
import {
  withAutoTracing,
  withoutAutoTracing,
  setSpanName
