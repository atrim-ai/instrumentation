/**
 * Effect-TS Auto-Tracing Example (Console Exporter / Development Mode)
 *
 ...
 * - Exporter type (console), processor (simple) - all from YAML
...
console.log('============================================================')
console.log('Effect-TS Auto-Tracing Example (Console / Development Mode)')
console.log('============================================================')
console.log('All configuration from instrumentation.yaml:')
console.log('  - Exporter: effect.exporter_config.type = "console"')
console.log('  - Processor: effect.exporter_config.processor = "simple"')
...
const main = Effect.gen(function* () {
  ...
  console.log('NOTE: Spans will be printed to console as they complete.\n')
  ...
  console.log('Spans were exported to console above.')
  console.log('============================================================')

  // Small delay to ensure all spans are flushed
